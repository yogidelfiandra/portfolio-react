      ...
      <div className='container'>
        ...
        <div className='w-full pt-10 border-t border-slate-800'>
          <div className='flex items-center justify-center mb-5'>
            <a
              href='https://github.com/yogidelfiandra'
              target='_blank'
              rel='noopener noreferrer'
              className='w-9 h-9 mr-3 flex justify-center items-center border rounded-full border-slate-300 text-slate-300 hover:text-primary hover:border-primary hover:border-2'
            >
              <svg
                role='img'
                width={20}
            ...
            <a
              href='https://twitter.com/yogiidelfiandra'
              target='_blank'
              rel='noopener noreferrer'
              className='w-9 h-9 mr-3 flex justify-center items-center border rounded-full border-slate-300 text-slate-300 hover:text-primary hover:border-primary hover:border-2'
            >
            ...
            <a
              href='https://www.linkedin.com/in/yogiidelfiandra/'
              target='_blank'
              rel='noopener noreferrer'
              className='w-9 h-9 mr-3 flex justify-center items-center border rounded-full border-slate-300 text-slate-300 hover:text-primary hover:border-primary hover:border-2'
            >
