...
export default function Experience(props) {
  return (
    <section id='experience' className='bg-slate-100 pt-36 pb-32'>
        ...
        <div className='flex flex-wrap justify-center'>
          {props.data.map((item, index1) => {
            return (
              ...
              >
                <div className='rounded-xl bg-slate-800 py-4 text-center text-white shadow-sm transition duration-500 hover:bg-slate-700 '>
